...
--
-- Host: localhost
-- Generation Time: Apr 12, 2010 at 04:28 PM
...
INSERT INTO `file` (`filename`, `clinicNum`) VALUES
('file1.xml', 100000001),
('file2.xml', 100000002),
('file3.xml', 100000003);
...
INSERT INTO `icd9procedurecode` (`ICD9ProcedureCodeID`, `ICD9ProcedureCode`, `clinicNum`) VALUES
(1, '01.02', 100000001),
(2, '01.41', 100000002),
(3, '01.52', 100000002),
(4, '39.64', 100000004),
...
INSERT INTO `patient` (`clinicNum`, `DOB`, `weight`, `height`, `gender`, `side`, `extremity`, `lastName`, `firstName`) VALUES
(100000001, '2000-01-01', 35.0, 100.0, 'F', 'L', 'u', 'McKinley', 'Jolene'),
(100000002, '1990-03-02', 45.0, 154.0, 'F', 'R', 'u', 'McKinley', 'Sarah'),
(100000003, '1985-07-03', 100.0, 201.0, 'M', 'L', 'l', 'Smith', 'Joe'),
(100000004, '1962-04-05', 120.0, 224.0, 'M', 'R', 'l', 'Jones', 'Mike'),
(100000005, '1976-01-25', 200.0, 220.0, 'F', 'L', 'L', 'Claus', 'Santa');
